		...
		>
			...
			<div className='house-card__info'>
				<div className='house-card__info-text-container'>
					...
					<p className='paragraph house-card__summary'>{house.summary}</p>
				</div>
			...
			<div className='house-card__info-row'>
				<div className='house-card-item-column'>
					<p className='house-card__paragraph'>${house.price} per person</p>
				...
				<div className='house-card-item'>
					<Link to={'/joe-kenya'} className='btn-grad house-btn nav__link'>
						bruh
					</Link>
				</div>
			</div>
